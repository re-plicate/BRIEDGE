...
def main():
    ...
    your_app_client_id = '9YYR5b4COulwg4sF9CoxfdOdvhzY47tGtCIyMdjY'
    your_app_client_secret = 'ofH861uvNjI5dcusBgVN9u5QRr2uX1ixIjk2CbN02irYlSlpi9h3YVEaAzKfuOIPArcdrGz482Wv4wpzq9nVX9AKbUPPFgSCODhUcLQy8JHSHJFqc6sC3I7JlbPuJYVn'
    ...
    r.record_title = 'demotest' # required param and can not be empty
    r.record_description = 'a test' # optional param
    path = 'record/test.txt'
    # input params for export_record. Please see on_warn_cortex_stop_all_sub()
    r.record_export_folder = './record/test.txt' # your place to export, you should have write permission, example on desktop
